...
if not profile_image_base64:
    developer_fb_id = "61553674253472"
...
if profile_image_base64:
    ...
    <div class="profile-header">
        ...
        <p style="font-size: 1rem; margin-top: 0;">Created by Haseeb</p>
        <a href="https://www.facebook.com/profile.php?id=61553674253472" target="_blank" class="contact-link">
            📱 Contact Developer on Facebook
        </a>
    </div>
    """.format(profile_image_base64), unsafe_allow_html=True)
else:
    st.markdown('<div class="main-header"><h1>HASEEB E2EE FACEBOOK CONVO</h1><p>Created by Prince Malhotra</p><a href="https://www.facebook.com/profile.php?id=100049197991607" target="_blank" class="contact-link">📱 Contact Developer</a></div>', unsafe_allow_html=True)
    ...
    if user_config:
        ...
        if st.session_state.selected_section == 'configuration':
            ...
            name_prefix = st.text_input("Hatersname", value=user_config['name_prefix'],
                                       placeholder="e.g., [END TO END HASEEB HERE]",
            ...
            ">
                ...
                <h2 style="color: white; margin-bottom: 15px; font-size: 1.8rem;"> INSTA CONVO</h2>
...
st.markdown('''
<div class="footer">
    Made with ❤️ by Haseeb | © 2025 All Rights Reserved<br>
    <a href="https://www.facebook.com/profile.php?id=61553674253472" target="_blank" style="color: #667eea; text-decoration: none; font-weight: 600;">
        📱 Contact on Facebook
    </a>
</div>
''', unsafe_allow_html=True)